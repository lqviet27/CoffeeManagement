...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = CoffeeManagement.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = CoffeeManagement.Properties.Resources.calendarDark;
                else calendarIcon = CoffeeManagement.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
